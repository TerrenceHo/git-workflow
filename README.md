...
The _master_ branch should be stable. No one should be able to push directly to 
...
_featureB_ should have 1) merged off of _develop_, to work off clean code, and 
